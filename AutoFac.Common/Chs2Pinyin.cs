...
namespace AutoFac.Common
{
    ...
    public class Chs2Pinyin
    {
        ...
        private static string[] otherChinese = new string[]
        {
             ...
             ,"黟","黢","黩","黧","黥","黪","黯","鼢","鼬","鼯","鼹","鼷","鼽","鼾","齄","珺"
        };
        ...
        private static string[] otherPinYin = new string[]
           {
                "Chu","Ji","Wu","Gai","Nian","Sa","Pi","Gen","Cheng","Ge","Nao","E","Shu","Yu","Pie","Bi",
                 ...
                 "Xia","Yi","Qu","Du","Li","Qing","Can","An","Fen","You","Wu","Yan","Xi","Qiu","Han","Zha","Jun"
           };
        #endregion 二级汉字   
        #region 变量定义   
        ...
        /// </summary>   
        /// <param name="ch"></param>   
        /// <param name="type">0首字母大写，1全小写，2全大写</param>   
        /// <returns></returns>   
        public static String Get(Char ch, int type = 0)
        {
            // 拉丁字符               
            ...
            if ((chr > lastChCode || chr < firstChCode) && chr != -21438)
            {
                return ch.ToString();
            }
            // 如果是在一级汉字中   
            else if (chr <= lastOfOneLevelChCode && chr >= firstChCode)
            {
                // 将一级汉字分为12块,每块33个汉字.   
        ...
        public static String Get(String str, string separator = "", int type = 0)
        {
            if (String.IsNullOrEmpty(str)) return String.Empty;
            ...
            {
                sb.Append(Get(chs[j], type) + separator);
            }
